...
insert into sys_config values(4, '账号自助-查询码开关',           'sys.account.captchaEnabled',       'true',          'Y', 'admin', sysdate(), '', null, '是否开启查询码功能（true开启，false关闭）');
